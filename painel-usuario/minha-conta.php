	...
	<main>
		...
		<section class="float-left content">
			<article class="bgcolor-white text-left info">
				<br>
				<h1 class="color-dark text-left font-text-light-extra font-weight-heavy texto_margem">Gerenciar Minha Conta</h1>
				...
				<a href="dados-acesso" class="color-white text-left link-bgcolor-blue-dark-b">Mudar Senha</a>
				<a href="excluir-conta?ref=2" class="link-bgcolor-red-dark-b color-white">Excluir Conta</a>
				<div class="espaco-min"></div>
				</div>
				<div class="espaco-normal"></div>
