...
<html lang="pt-br">
	...
	<main>
		...
		<section class="float-left content_left">
			...
			<article class="bgcolor-dark-full text-center info nav">
				...
				<div class="bgcolor-white font-text-light-extra float-left divisor2" >
					<div class="espaco-min"></div>
						<p class="font-text-light-extra text-center color-dark-full">Último Acesso</p>
						<p class="font-text-hard-two text-center color-black">21/01/2017</p>
					<div class="espaco-min"></div>
				</div>
				
				<div class="bgcolor-white font-text-light-extra float-left divisor2">
					<div class="espaco-min"></div>
						<p class="font-text-light-extra text-center color-dark-full">Meus Pontos</p>
						<p class="font-text-hard-two text-center color-black">21 pontos</p>
					<div class="espaco-min"></div>
				</div>
			</article>
		</section>
		...
		<section class="float-left content">
			<article class="bgcolor-white text-left info">
				<br>
				<h1 class="color-dark text-left font-text-light-extra font-weight-heavy texto_margem">Pedidos mais recentes</h1>
				...
				<div class="espaco-normal"></div>
				<a href="pedidos" class="link-bgcolor-green-dark-b color-white">Ver Todos os Pedidos</a>
				<div class="espaco-min"></div>
				<div class="espaco-min"></div>
