	...
	<main>
		...
		<section class="float-left content">
			<article class="bgcolor-white text-left info">
				<br>
				<h1 class="color-dark text-left font-text-light-extra font-weight-heavy texto_margem">Gerenciar Endereços de Entregas</h1>
				<div class="divisor1 bgcolor-white-dark">
					<div class="espaco-min"></div>
					<form method="post">
						<label for="titulo">Título:</label><br>
						<input type="text" name="titulo" value="Casa" class="bgcolor-white font-text-light-extra color-dark-full"><br>
						...
						<button name="alterar" value="Alterar" class="link-bgcolor-green-dark-b font-text-light-extra color-white">Alterar Endereço</button>
					</form>
					<div class="espaco-min"></div>
				</div>
