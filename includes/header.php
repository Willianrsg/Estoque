<header>
	...
	<section class="bgcolor-dark nav_menu text-center">
		<h1 class="fontzero">Navegação Por Menus</h1>
			...
			<ul class="font-text-light-extra font-weight-medium" id="mostra_menu">
				<li><a href="dashboard" title="Página Principal do Sistema" class="color-white">Home</a></li>
				...
				<li><a href="sair?pagina=<?= $pages ?>" title="Página de Saida do Sistema" class="color-white">Sair</a></li>
			</ul>
	</section>
</header>