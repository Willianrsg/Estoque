	...
	<main>
		<section class="content_left">
			...
			<article class="bgcolor-white extends more">
				...
				<form method="post">
					<input type="text" name="pesquisa" autocomplete="on" id="pesquisa" placeholder="Digite o nome do fornecedor para edição..."><br>
				...
				<div class="divisor bgcolor-white-dark color-dark info_dados">
					...
					<p class="font-text-light-extra text-center font-weight-medium color-red-light space-letter text-left"><a href="alterar-fornecedor.php?ref=<?= $mostra['id_fornecedor']?>" class="color-white link-bgcolor-blue-b">Alterar Dados</a></p>
