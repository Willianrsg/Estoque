	...
	<main>
		<section class="content_left">
			...
			<article class="bgcolor-white extends more">
				<h1 class="font-text-hard-two text-center font-weight-heavy bgcolor-dark color-white">ALTERAR DADOS DO CLIENTE NO SISTEMA <?= strtoupper(TITLE) ?></h1>
