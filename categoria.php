	...
	<main>
		<section class="float-left content_left">
			...
			<article class="bgcolor-dark text-center font-text-light-extra divisor post_views">
				<h1 class="font-text-light text-center font-weight-heavy bgcolor-dark color-white">CATEGORIA TECNOLOGIA E TI!</h1>
				<p class="font-text-light text-center font-weight-medium bgcolor-dark color-white-dark">Role a página e escolha o seu artigo preferido!</p>
				<div class="divisor1">
					<a title="Artigo: TITULO ARTIGO">
			...
			<!-- Chama a paginação -->
			<?php require 'includes/post-videos.php'; ?>
