		...
		<section class="content_left">
			...
			<article class="bgcolor-white extends more">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<label for="preco">Descrição do Produto<a href="nova-categoria" class="link-bgcolor-blue-dark-b color-white texto_margem">Nova Categoria</a></label><br>
					<select>
					...
					<button name="cadastro_produto" class="link-bgcolor-green-dark-b color-white">Finalizar Cadastro</button>
